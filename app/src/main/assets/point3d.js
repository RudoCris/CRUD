...
Point3d.prototype.distanceTo = function (point){
    return parseFloat(Math.sqrt(Math.pow(this.x-point.x,2) + Math.pow(this.y-point.y,2) + Math.pow(this.z-point.z,2)).toFixed(2));
};

Point3d.prototype.isVisible = function () {
    return this.z > -this.fl;   
};
